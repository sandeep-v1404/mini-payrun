              ...
              <Field label="Employee Code">
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      employeeCode: sanitizeInput(e.target.value),
                    })
                  }
                  placeholder="Autogenerated if not provided (EMP00...)"
                />
              </Field>
              ...
              <Field label="BSB (Optional)">
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      bsb: sanitizeInput(e.target.value),
                    })
                  }
                  placeholder="083-123"
                  disabled={
              ...
              <Field label="Account Number (Optional)">
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      account: sanitizeInput(e.target.value),
                    })
                  }
